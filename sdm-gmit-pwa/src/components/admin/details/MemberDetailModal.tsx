        ...
        <div className="flex flex-col gap-5 animate-fade-in-up max-h-[75vh] overflow-y-auto custom-scrollbar pr-1 pb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm lg:col-span-1 md:row-span-2">
                    <SectionTitle icon="badge" title="Data Umum" />
                    <div className="mt-4 space-y-3">
                        ...
                        <DetailRow label="Usia" value={calculateAge(member.birthDate)} />
                        <DetailRow label="Nomor Telepon/ WhatsApp Aktif" value={member.phone} />
                        <DetailRow label="Lingkungan" value={member.lingkungan} />
                        <DetailRow label="Rayon" value={member.rayon} />
                        <DetailRow label="Alamat Lengkap" value={member.address} />
