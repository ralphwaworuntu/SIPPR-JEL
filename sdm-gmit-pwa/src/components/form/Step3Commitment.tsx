                            ...
                            return (
                                <div key={index} className="p-5 border-2 border-primary/40 rounded-2xl bg-white dark:bg-slate-800/80 relative animate-fade-in-up transition-all duration-300 shadow-xl shadow-primary/5 mt-4 group">
                                    <button
                                        ...
                                        className="absolute top-4 right-4 text-red-500 hover:text-white transition-all bg-red-50 dark:bg-red-900/20 hover:bg-red-500 p-2 rounded-xl"
                                        title="Hapus Anggota"
                                    >
                                        <span className="material-symbols-outlined text-[18px]">delete</span>
                                    </button>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="pt-6 mt-4 border-t border-slate-200 dark:border-slate-700 flex justify-end gap-3">
                                            <button
                                                ...
                                                className="bg-primary text-white font-bold px-6 py-2.5 rounded-xl hover:bg-primary/90 flex items-center gap-2 shadow-lg shadow-primary/25 transition-all hover:-translate-y-0.5"
                                            >
