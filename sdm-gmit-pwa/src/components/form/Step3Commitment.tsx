    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="space-y-4">
                <label className="text-[#0d1b12] dark:text-[#f8fcf9] text-base font-bold leading-normal block">Willingness to Serve</label>
                <div className="grid md:grid-cols-2 gap-4">
                    <label className={`cursor-pointer p-4 border rounded-xl flex items-center gap-3 transition-all ${data.willingnessToServe === 'Aktif' ? 'border-primary bg-primary/10 shadow-sm' : 'border-[#cfe7d7] hover:bg-[#e7f3eb] dark:border-[#1d3324] dark:hover:bg-[#1d3324]'}`}>
                        ...
                        />
                        <div>
                            <span className="block font-semibold text-[#0d1b12] dark:text-white">Active / Routine</span>
                            <span className="text-sm text-[#4c9a66]">Willing to be involved in routine ministry or permanent committees.</span>
                        </div>
                    </label>
                    ...
                    <label className={`cursor-pointer p-4 border rounded-xl flex items-center gap-3 transition-all ${data.willingnessToServe === 'On-demand' ? 'border-primary bg-primary/10 shadow-sm' : 'border-[#cfe7d7] hover:bg-[#e7f3eb] dark:border-[#1d3324] dark:hover:bg-[#1d3324]'}`}>
                        ...
                        />
                        <div>
                            <span className="block font-semibold text-[#0d1b12] dark:text-white">On-demand</span>
                            <span className="text-sm text-[#4c9a66]">Willing to be contacted whenever expertise is needed.</span>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div className="space-y-4">
                <label className="text-[#0d1b12] dark:text-[#f8fcf9] text-base font-bold leading-normal block">Areas of Interest</label>
                <p className="text-sm text-[#4c9a66]">Select areas where you are interested in contributing.</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {interestOptions.map(option => (
                        <label key={option} className={`flex items-center gap-3 p-3 border rounded-lg cursor-pointer transition-colors ${data.interestAreas.includes(option) ? 'border-primary bg-primary/5' : 'border-[#cfe7d7] hover:bg-[#e7f3eb] dark:border-[#1d3324] dark:hover:bg-[#1d3324]'}`}>
                            ...
                            />
                            <span className="text-[#0d1b12] dark:text-[#f8fcf9] text-sm font-medium">{option}</span>
                        </label>
                    ))}
                </div>
            </div>
            ...
            <div className="space-y-4">
                <label className="text-[#0d1b12] dark:text-[#f8fcf9] text-base font-bold leading-normal block">Contribution Type</label>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
