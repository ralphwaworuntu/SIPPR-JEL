...
const Step4Education: React.FC<StepProps> = ({ data, update }) => {
    ...
    const maxMembers = parseInt(data.familyMembers) || 20;
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            <div className="bg-white dark:bg-[#1a2e20] rounded-2xl shadow-sm border border-slate-100 dark:border-white/5 overflow-hidden transition-all duration-300">
                <div className="px-5 py-4 flex items-center gap-3 border-b border-slate-50 dark:border-white/5 bg-orange-500 bg-opacity-10 dark:bg-opacity-20">
                    <div className="p-2 rounded-lg bg-orange-500 text-white shadow-sm">
                        <span className="material-symbols-outlined text-[20px]">school</span>
                    </div>
                    <h4 className="font-bold text-gray-800 dark:text-white text-base tracking-wide">Data Pendidikan Keluarga</h4>
                </div>
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div className="space-y-4">
                        <SectionHeader title="Apakah semua anak usia sekolah (7-18 tahun) ke atas sedang bersekolah di semua jenjang pendidikan?" tooltipText="Pilih kondisi pendidikan anak di rumah tersebut." />
                        <FormRadioGroup
                    ...
                    {showDropout && (
                        <div className="space-y-6">
                            <div className="space-y-4">
                                <SectionHeader title="Putus Sekolah" tooltipText="Informasi mengenai anggota keluarga yang berhenti bersekolah sebelum waktunya." />
                                <FormRadioGroup
                                    label="Apakah ada anggota keluarga yang putus sekolah?"
                                    id="education_hasDropout"
                                    name="education_hasDropout"
                                    options={['Ya', 'Tidak']}
                                    value={data.education_hasDropout || ''}
                                    onChange={(val) => {
                                        if (val === 'Tidak') {
                                            update({
                                                education_hasDropout: val as 'Ya' | 'Tidak',
                                            ...
                                            update({ education_hasDropout: val as 'Ya' | 'Tidak' });
                                        }
                                    }}
                                    columns={2}
                                />
                            ...
                            {data.education_hasDropout === 'Ya' && (
                                <div className="space-y-6 animate-fadeIn pl-4 border-l-2 border-primary/20">
                                    <div className="space-y-2">
                                        <label className="text-xs font-semibold text-slate-600 dark:text-slate-400 flex items-center z-10">
                                            Alasannya? <span className="text-red-500 ml-1">*</span>
                                        </label>
                                        <textarea
                                            value={data.education_dropoutReason || ''}
                                            onChange={(e) => update({ education_dropoutReason: e.target.value })}
                                    ...
                                    <div className="space-y-4">
                                        <SectionHeader title="Detail Anak Putus Sekolah:" tooltipText="Isi jumlah dan jenjang pendidikan terakhir anak yang putus sekolah." />
                                        <div className="max-w-[200px] flex flex-col gap-2">
