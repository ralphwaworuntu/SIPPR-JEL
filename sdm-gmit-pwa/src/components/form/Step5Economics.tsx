        ...
        <div className="space-y-6 animate-fadeIn">
            <div className="bg-white dark:bg-[#1a2e20] rounded-2xl shadow-sm border border-slate-100 dark:border-white/5 overflow-hidden transition-all duration-300">
                <div className="px-5 py-4 flex items-center gap-3 border-b border-slate-50 dark:border-white/5 bg-emerald-500 bg-opacity-10 dark:bg-opacity-20">
                    ...
                    <h4 className="font-bold text-gray-800 dark:text-white text-base tracking-wide">Sumber Pendapatan Utama Keluarga</h4>
                </div>
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div className="space-y-6 pt-8 mt-4 relative z-[30]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-2 relative z-10">
                                <label className="text-sm font-bold text-slate-800 dark:text-white flex items-center gap-1 z-10">
                                    Pembangunan <span className="text-xs font-normal text-slate-500">(Pakaian, Hiburan, Tabungan)</span><span className="text-red-500">*</span> <FormTooltip text="Biaya transportasi, pakaian, atau hiburan." />
                                </label>
                            ...
                            <div className="flex flex-col gap-2 relative z-10">
                                <label className="text-sm font-bold text-slate-800 dark:text-white flex items-center gap-1 z-10">
                                    Persembahan <span className="text-xs font-normal text-slate-500">(Kumpul keluarga, Dukacita, Sumbangan lainnya, dll)</span><span className="text-red-500">*</span> <FormTooltip text="Biaya transportasi, pakaian, atau hiburan." />
                                </label>
