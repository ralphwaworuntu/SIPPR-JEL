...
const AdminMemberData = () => {
    ...
    const handleExportCSV = () => {
        const headers = [
            ...
            "Status Anak Bersekolah", "Total Anak Bersekolah", "TK/PAUD (Sekolah)", "SD (Sekolah)", "SMP (Sekolah)", "SMA (Sekolah)", "Perguruan Tinggi (Sekolah)", "Total Anak Putus Sekolah", "SD (Putus)", "SMP (Putus)", "SMA (Putus)", "Perguruan Tinggi (Putus)", "Total Anak Tidak Sekolah Belum Bekerja", "SD (Tidak Sekolah Belum Bekerja)", "SMP (Tidak Sekolah Belum Bekerja)", "SMA (Tidak Sekolah Belum Bekerja)", "Perguruan Tinggi (Tidak Sekolah Belum Bekerja)", "Total Anak Sudah Bekerja", "Anak Sudah Bekerja", "Penerima Beasiswa", "Jenis Beasiswa",
            //Step 4
            "Sakit Dalam 30 Hari Terakhir", "Anggota Keluarga Sakit Menahun", "Pengobatan Teratur Dari Fasilitas Kesehatan", "BPJS Kesehatan", "BPJS Ketenagakerjaan", "KPM Bansos", "Jenis Bantuan Sosial?", "KK Miskin Non-KPM", "Alasan Miskin Non-KPM", "Penyandang Disabilitas?", "Disabilitas Ganda?", "Disabilitas Fisik", "Disabilitas Intelektual", "Disabilitas Mental", "Disabilitas Sensorik", "Bersedia Donor Darah", "Anggota Komunitas Donor",
            //Step 5
            "Nama Kepala Keluarga", "Kategori Pekerjaan", "Tempat Kerja/Instansi", "Jabatan Saat Ini", "Lama Bekerja", "Keahlian Spesifik", "Memiliki Keahlian Profesional", "Jenis Keahlian Utama", "Tingkat Keahlian", "Terlibat Pelayanan", "Bidang Minat Pelayanan", "Bentuk Kontribusi", "Persetujuan Bergabung Komunitas",
            //Step 6
            "Pekerjaan Utama Kepala Keluarga", "Pendapatan Utama Kepala Keluarga", "Pekerjaan Utama Istri/Suami", "Pendapatan Istri/Suami", "Total Range Pendapatan Per Bulan", "Konsumsi Pangan", "Kebutuhan Konsumsi Dasar Non-Pangan 1", "Kebutuhan Dasar Non-Pangan 2", "Beban Pinjaman Bank/Koperasi", "Kebutuhan Pendidikan & Kesehatan", "Kebutuhan Lainnya", "Kebutuhan Tak Terduga", "Kebutuhan Peribadatan", "Total Pengeluaran Rumah Tangga Per Bulan", "Punya Usaha Ekonomi Produktif ", "Nama JenisUsaha/Brand", "Jenis Usaha", "Lama Usaha Berjalan", "Status Usaha", "Lokasi Usaha", "Jumlah Tenaga Kerja", "Modal Awal Usaha", "Rata-rata Omset Per Bulan", "Sumber Modal Utama", "Memiliki Izin Usaha", "Cara Pemasaran Utama", "Wilayah Pemasaran", "Tantangan Utama Usaha", "Dukungan Utama Yang Dibutuhkan", "Bersedia Berbagi Ilmu Usaha", "Bersedia Pelatihan Kewirausahaan", "Status Rumah", "Tipe Rumah", "Memiliki Aset  Transportasi/ElektronikLahan", "Punya Aset?", "Motor", "Mobil", "Kulkas", "Laptop/Komputer", "TV", "Internet", "Lahan Pertanian", "Total Keseluruhan Aset", "Status Kepemilikan Tanah", "Jenis Sumber Air Minum Utama", "Daya Listrik 450", "Daya Listrik 900", "Daya Listrik 1200", "Daya Listrik 2200", "Daya Listrik 5000"
        ...
        const rows = filteredMembers.map(m => {
            ...
            const totalDropout = sum(m.education_dropout_tk_paud, m.education_dropout_sd, m.education_dropout_smp, m.education_dropout_sma, m.education_dropout_university);
                                                    ...
                                                    switch (tableTab) {
                                                        ...
                                                        case 'Kesehatan':
                                                            cols = [
                                                                ...
                                                                { label: "Anggota Keluarga Sakit Menahun", key: "health_chronicSick", width: "min-w-[100px]" },
                                                                ...
                                                                { label: "KPM Bansos", key: "health_isKPM", width: "min-w-[100px]" },
                                                                { label: "Jenis Bantuan Sosial", key: "health_socialAssistance", width: "min-w-[100px]" },
                                                                { label: "KK Miskin Non-KPM", key: "health_isPoorNonKPM", width: "min-w-[120px]" },
                                                                { label: "Alasan Miskin Non-KPM", key: "health_poorNonKPMReason", width: "min-w-[150px]" },
                                                                { label: "Anggota Keluarga Penyandang Disabilitas", key: "health_hasDisability", width: "min-w-[100px]" },
                                                                { label: "Disabilitas Fisik", key: "health_disabilityPhysical", width: "min-w-[150px]" },
                                                                { label: "Disabilitas Intelektual", key: "health_disabilityIntellectual", width: "min-w-[150px]" },
                                                                { label: "Disabilitas Mental", key: "health_disabilityMental", width: "min-w-[150px]" },
                                                                { label: "Disabilitas Sensorik", key: "health_disabilitySensory", width: "min-w-[150px]" },
                                                                { label: "Disabilitas Ganda", key: "health_disabilityDouble", width: "min-w-[150px]" },
                                                                { label: "Bersedia Donor Darah", key: "health_willingToDonateBlood", width: "min-w-[150px]" },
                                                                { label: "Anggota Komunitas Donor", key: "health_willingToJoinBloodCommunity", width: "min-w-[180px]" }
                                                            ];
                                                            break;
                                                            ...
                                                            <>
                                                                ...
                                                                {tableTab === 'Kesehatan' && (
                                                                    <>
                                                                        ...
                                                                        <td className="px-6 py-4 text-sm"><span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${member.health_isKPM === 'Ya' ? 'bg-indigo-100 text-indigo-600 border border-indigo-200' : 'text-slate-400'}`}>{member.health_isKPM || '-'}</span></td>
                                                                        ...
                                                                        <td className="px-6 py-4 text-sm"><span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${member.health_isPoorNonKPM === 'Ya' ? 'bg-amber-100 text-amber-600 border border-amber-200' : 'text-slate-400'}`}>{member.health_isPoorNonKPM || '-'}</span></td>
                                                                        <td className="px-6 py-4 text-xs text-slate-500 truncate max-w-[150px]" title={member.health_poorNonKPMReason || '-'}>{member.health_poorNonKPMReason || '-'}</td>
                                                                        ...
                                                                        <td className="px-6 py-4 text-sm text-center">
                                                                            <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${member.health_disabilityDouble ? 'bg-orange-100 text-orange-600 border border-orange-200' : 'text-slate-400'}`}>{member.health_disabilityDouble ? 'YA' : '-'}</span>
                                                                        </td>
                                                                        <td className="px-6 py-4 text-sm text-center font-bold text-slate-900 dark:text-white">{member.health_willingToDonateBlood || '-'}</td>
                                                                        <td className="px-6 py-4 text-sm text-center font-bold text-slate-900 dark:text-white">{member.health_willingToJoinBloodCommunity || '-'}</td>
                                                                    </>
                                                                )}
                                                                ...
                                                                {tableTab === 'Ekonomi' && (
                                                                    <>
                                                                        ...
                                                                        <td className="px-6 py-4 text-xs text-slate-500 truncate max-w-[150px]" title={Array.isArray(member.economics_businessTraining) ? member.economics_businessTraining.join(', ') : (member.economics_businessTraining || '-')}>{Array.isArray(member.economics_businessTraining) ? (member.economics_businessTraining.join(', ') || '-') : (member.economics_businessTraining || '-')}</td>
