...
const AdminMemberData = () => {
    ...
    const handleDownloadTemplate = () => {
        const headers = [
            ...
            "SD (Putus)", "SMP (Putus)", "SMA (Putus)", "Universitas (Putus)",
            ...
            "Punya Usaha?", "Nama Usaha", "Jenis Usaha", "Lama Usaha", "Status Usaha", "Lokasi Usaha", "Jml Karyawan", "Modal Usaha", "Sumber Modal", "Izin Usaha", "Cara Pemasaran", "Cakupan Pemasaran", "Tantangan Usaha", "Kebutuhan Usaha", "Bersedia Pelatihan", "Bersedia Berbagi Ilmu Usaha",
            "Status Rumah", "Jenis Rumah", "IMB", "Punya Aset?", "Total Aset Berharga", "Motor", "Mobil", "Kulkas", "Laptop", "TV", "Internet", "Lahan (bidang)", "Sumber Air", "Listrik 450", "Listrik 900", "Listrik 1300", "Listrik 2200", "Listrik >5000", "Total Biaya Listrik",
            "Sakit 30 Hari Terakhir", "Penderita Penyakit Kronis", "Daftar Penyakit", "Berobat Rutin", "Punya BPJS Kesehatan?", "Punya BPJS Ketenagakerjaan?", "Punya Bantuan Sosial?", "Penyandang Disabilitas?", "Disabilitas Ganda?", "Disabilitas Fisik", "Disabilitas Intelektual", "Disabilitas Mental", "Disabilitas Sensorik",
            "Latitude", "Longitude"
        ];
    ...
    const handleExportCSV = () => {
        const headers = [
            "Nomor Kartu Keluarga", "NIK", "Nama Lengkap", "Jenis Kelamin", "Tanggal Lahir", "Usia", "Golongan Darah", "Status Kawin", "Tanggal Kawin", "Jenis Kawin", "Status Baptis", "Status Sidi", "Nomor Telepon/ WhatsApp Aktif",
            "Kota", "Kecamatan", "Kelurahan", "Lingkungan", "Rayon", "Alamat Lengkap",
            "Total Anggota Keluarga", "Laki-laki", "Perempuan", "Di Luar Kota", "Sudah Sidi", "Sidi Laki-laki", "Sidi Perempuan", "Belum Baptis", "Belum Sidi",
            "Penerima Diakonia", "Tahun Diakonia", "Jenis Diakonia",
            "Pendidikan Terakhir", "Jurusan", "Kategori Pekerjaan", "Jabatan", "Nama Instansi", "Lama Kerja (Tahun)", "Daftar Keahlian",
            "Kesediaan Melayani", "Minat Pelayanan", "Bentuk Kontribusi",
            "Status Anak Bersekolah", "TK/PAUD (Sekolah)", "SD (Sekolah)", "SMP (Sekolah)", "SMA (Sekolah)", "Universitas (Sekolah)",
            "SD (Putus)", "SMP (Putus)", "SMA (Putus)", "Universitas (Putus)",
            "SD (Tidak Sekolah)", "SMP (Tidak Sekolah)", "SMA (Tidak Sekolah)", "Universitas (Tidak Sekolah)", "Anak Sudah Bekerja", "Penerima Beasiswa", "Jenis Beasiswa",
            "Pekerjaan KK", "Pekerjaan Pasangan", "Range Pendapatan", "Detail Range Pendapatan", "Pengeluaran Pangan", "Pengeluaran Utilitas", "Pengeluaran Non-Pangan 2", "Pengeluaran Cicilan", "Pengeluaran Pendidikan", "Pengeluaran Lainnya", "Pengeluaran Tak Terduga", "Pengeluaran Peribadatan",
            "Punya Usaha?", "Nama Usaha", "Jenis Usaha", "Lama Usaha", "Status Usaha", "Lokasi Usaha", "Jml Karyawan", "Modal Usaha", "Sumber Modal", "Izin Usaha", "Cara Pemasaran", "Cakupan Pemasaran", "Tantangan Usaha", "Kebutuhan Usaha", "Bersedia Pelatihan", "Bersedia Berbagi Ilmu Usaha",
            "Status Rumah", "Jenis Rumah", "IMB", "Punya Aset?", "Total Aset Berharga", "Motor", "Mobil", "Kulkas", "Laptop", "TV", "Internet", "Lahan (bidang)", "Sumber Air", "Listrik 450", "Listrik 900", "Listrik 1300", "Listrik 2200", "Listrik >5000", "Total Biaya Listrik",
            "Sakit 30 Hari Terakhir", "Penderita Penyakit Kronis", "Daftar Penyakit", "Berobat Rutin", "Punya BPJS Kesehatan?", "Anggota Tanpa BPJS", "Punya BPJS Ketenagakerjaan?", "Punya Bantuan Sosial?", "Penyandang Disabilitas?", "Disabilitas Ganda?", "Disabilitas Fisik", "Disabilitas Intelektual", "Disabilitas Mental", "Disabilitas Sensorik",
            "Latitude", "Longitude"
        ];
        ...
        const rows = filteredMembers.map(m => {
            return [
                esc(m.kkNumber), esc(m.nik), esc(m.name), esc(m.gender), esc(m.birthDate), calculateAge(m.birthDate), esc(m.bloodType), esc(m.maritalStatus), esc(m.marriageDate), esc(arrStr(m.marriageType)), esc(m.baptismStatus), esc(m.sidiStatus), esc(m.phone),
                esc(m.city), esc(m.district), esc(m.subdistrict), esc(m.lingkungan), esc(m.rayon), esc(m.address),
                                            ...
                                            <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800">
                                                ...
                                                {(() => {
                                                    ...
                                                    switch (tableTab) {
                                                        ...
                                                        case 'Ekonomi': cols = [...baseCols, { label: "Pekerjaan KK", key: "economics_headOccupation", width: "min-w-[150px]" }, { label: "Pek. Pasangan", key: "economics_spouseOccupation", width: "min-w-[150px]" }, { label: "Pendapatan", key: "economics_incomeRange", width: "min-w-[150px]" }, { label: "Total Pengeluaran", key: "economics_expense_food", width: "min-w-[150px]" }, { label: "Usaha UMKM", key: "economics_hasBusiness", width: "min-w-[120px]" }, { label: "Status Rumah", key: "economics_houseStatus", width: "min-w-[120px]" }, { label: "Tipe Rumah", key: "economics_houseType", width: "min-w-[120px]" }]; break;
